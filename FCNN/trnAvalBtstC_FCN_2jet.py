...
pth_dic       = {}
for i in tvt_l:
    pth_dic[i] = pth_root + '2jets/' + '/test/'+phpt[i]+'/'
...
n_batch_size = None#32#64    #16-1024#512#128
n_epochs     = 44#22#2#88
...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~testing
"""
print '#test qcd: ', len(df_qcd_dic[2])
df_qcd_dic[2]  = df_qcd_dic[2][:300] #100           #400#500    #1000#2000#5000
print '#test qcd: ', len(df_qcd_dic[2])
"""
#df_qcd_dic[1]  = df_qcd_dic[1][:6000] #6000#100#300
#n_train = 0#40#50#10#1
#df_qcd_dic[0]  = df_qcd_dic[0][-n_train:]#[:n_train] #100#500#1000
#print '#sgn train: ', len(sgn_inst['train'].df)
#print df_qcd_dic[0][:8]


tvt_dic          = {}
tvt_dic['train'] = pd.concat( [df_qcd_dic_j0[0], df_qcd_dic_j1[0], df_qcd_dic_j0[2], sgn_inst['train'].df] )
